...
(function (global, factory) {
  ...
  var __vue_render__$f = function() {
    ...
    var _h = _vm.$createElement;
    var _c = _vm._self._c || _h;
    return _c("div", { ref: _vm.ref, staticClass: "dao-border-box-1" }, [
      _c(
        "svg",
        {
          staticClass: "dv-border-svg-container",
            ...
            _c(
              ...
              [
                ...
                _c("feColorMatrix", {
                  attrs: {
                    values:
                      "0 0 0 0 0.00392156863   0 0 0 0 0.619607843   0 0 0 0 1  0 0 0 0.521388767 0",
                    type: "matrix",
                    in: "shadowInnerInner1"
                  }
                })
                ...
                _c(
                  "g",
                  {
                    attrs: {
                      transform:
                        "translate(" +
                        259.198824 * _vm.tempBase[0] +
                        ", " +
                        94.27653 * _vm.tempBase[1] +
                        ") scale(-1, -1) translate(" +
                        -259.198824 * _vm.tempBase[0] +
                        ", " +
                        -94.27653 * _vm.tempBase[1] +
                ...
                [
                  _c("rect", {
                    attrs: {
                      ...
                      x: "1",
                      y: "1",
                      width: "" + (_vm.width > 4 ? _vm.width - 4 : _vm.width),
                      height: "" + (_vm.height > 4 ? _vm.height - 4 : _vm.height),
                      rx: "2"
                    }
                  }),
                  _vm._v(" "),
  ...
  var script$w = {
    ...
    computed: {
      ...
      tempBase(state) {
        return [this.width / viewBase$4[0], this.height / viewBase$4[1]];
      }
  ...
  __vue_render__$w._withStripped = true;
    ...
    const __vue_inject_styles__$w = function (inject) {
      if (!inject) return
      inject("data-v-5fdb24e2_0", { source: ".dv-decoration-11 {\n  position: relative;\n  width: 100%;\n  height: 100%;\n  display: flex;\n}\n.dv-decoration-11 .decoration-content {\n  position: absolute;\n  top: 0px;\n  left: 0px;\n  width: 100%;\n  height: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n", map: {"version":3,"sources":["main.vue"],"names":[],"mappings":"AAAA;EACE,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,aAAa;AACf;AACA;EACE,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,WAAW;EACX,YAAY;EACZ,aAAa;EACb,mBAAmB;EACnB,uBAAuB;AACzB","file":"main.vue","sourcesContent":[".dv-decoration-11 {\n  position: relative;\n  width: 100%;\n  height: 100%;\n  display: flex;\n}\n.dv-decoration-11 .decoration-content {\n  position: absolute;\n  top: 0px;\n  left: 0px;\n  width: 100%;\n  height: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n"]}, media: undefined });
  ...
  var script$B = {
    ...
    methods: {
      ...
      mergeConfig() {
        ...
        console.log(util_1(defaultConfig, true), '111111');
        this.mergedConfig = util_2$1(util_1(defaultConfig, true), config || {});
      },
        ...
        _vm.mergedConfig
          ? [
              ...
              _c(
                ...
                { staticClass: "capsule-container" },
                _vm._l(_vm.capsuleLength, function(capsule, index) {
                  return _c("div", { key: index, staticClass: "capsule-item" }, [
                    _c("div", {
                      staticClass: "capsule-item-column",
                      style:
                        "width: " +
              ...
              _c(
                ...
                _vm._l(_vm.capsuleLength, function(capsule, index) {
                  return _c(
                    "div",
                    { key: index, staticClass: "capsule-item-value" },
                    [
                      _vm._v(
                        "\n        " +
                          _vm._s(_vm.capsuleValue[index]) +
                          "\n      "
                      )
                    ]
                  )
  ...
  class Animate {
    ...
    _firstCreate(bar) {
      this._first = false; // let bar = document.querySelector('#list')
  ...
  var script$J = {
    ...
    mounted() {
      ...
      myAnimate.init(document.getElementById('list'));
    },
  ...
  __vue_render__$J._withStripped = true;
    ...
    const __vue_inject_styles__$J = function (inject) {
      if (!inject) return
      inject("data-v-62287bd5_0", { source: "html[data-v-62287bd5], body[data-v-62287bd5], div[data-v-62287bd5], ul[data-v-62287bd5], li[data-v-62287bd5], img[data-v-62287bd5], span[data-v-62287bd5] {\n  padding: 0;\n  margin: 0;\n}\nul[data-v-62287bd5], li[data-v-62287bd5] {\n  list-style: none;\n}\nspan[data-v-62287bd5] {\n  display: inline-block;\n}\nimg[data-v-62287bd5] {\n  vertical-align: top;\n}\n#box[data-v-62287bd5] {\n  padding: 20px;\n  height: 700px;\n}\n#box ul[data-v-62287bd5] {\n  padding-left: 20px;\n  position: relative;\n}\n#box li[data-v-62287bd5] {\n  margin-left: 60px;\n  height: 28px;\n  box-sizing: border-box;\n  position: absolute;\n  line-height: 28px;\n  transition: width ease 1s, transform ease 1s, opacity ease 1s;\n  opacity: 0;\n  background: #ddd;\n  border-radius: 20px;\n  box-shadow: inset -5px 0px 25px rgba(0, 0, 0, 0.4);\n}\n#box li .name[data-v-62287bd5] {\n  position: absolute;\n  left: -60px;\n  white-space: nowrap;\n}\n#box li .count[data-v-62287bd5] {\n  margin-left: 15px;\n  position: absolute;\n  left: 100%;\n  font-size: 18px;\n  letter-spacing: 1px;\n  color: #fff;\n  font-style: italic;\n  text-shadow: 1px 0 2px #000, 0 1px 2px #000;\n}\n\n/*# sourceMappingURL=main.vue.map */", map: {"version":3,"sources":["/Users/dingshuo/DAOLCLOUD/DCProject/DataV/src/components/sortBoard/main.vue","main.vue"],"names":[],"mappings":"AA0BA;EACA,UAAA;EACA,SAAA;ACzBA;AD4BA;EACA,gBAAA;ACzBA;AD4BA;EACA,qBAAA;ACzBA;AD4BA;EACA,mBAAA;ACzBA;AD4BA;EACA,aAAA;EACA,aAAA;ACzBA;AD4BA;EACA,kBAAA;EACA,kBAAA;ACzBA;AD4BA;EACA,iBAAA;EACA,YAAA;EACA,sBAAA;EACA,kBAAA;EACA,iBAAA;EACA,6DAAA;EACA,UAAA;EACA,gBAAA;EACA,mBAAA;EACA,kDAAA;ACzBA;AD4BA;EACA,kBAAA;EACA,WAAA;EACA,mBAAA;ACzBA;AD4BA;EACA,iBAAA;EACA,kBAAA;EACA,UAAA;EACA,eAAA;EACA,mBAAA;EACA,WAAA;EACA,kBAAA;EACA,2CAAA;ACzBA;;AAEA,mCAAmC","file":"main.vue","sourcesContent":["<template>\n  <ul id=\"list\"></ul>\n</template>\n\n<script>\nimport Animate from './sort.js'\nexport default {\n  name: 'SortBoard',\n  components: {},\n  props: {},\n  data() {\n    return {\n    }\n  },\n  computed: {},\n  watch: {},\n  created() {},\n  mounted() {\n    let myAnimate = new Animate()\n    myAnimate.init(document.getElementById('list'))\n  },\n  methods: {}\n  \n}\n</script>\n<style lang=\"scss\" scoped>\n    html, body, div, ul, li, img, span {\n      padding: 0;\n      margin: 0;\n    }\n \n    ul, li {\n      list-style: none\n    }\n \n    span {\n      display: inline-block;\n    }\n \n    img {\n      vertical-align: top;\n    }\n \n    #box {\n      padding: 20px;\n      height: 700px;\n    }\n \n    #box ul {\n      padding-left: 20px;\n      position: relative;\n    }\n \n    #box li {\n      margin-left: 60px;\n      height: 28px;\n      box-sizing: border-box;\n      position: absolute;\n      line-height: 28px;\n      transition: width ease 1s, transform ease 1s, opacity ease 1s;\n      opacity: 0;\n      background: #ddd;\n      border-radius: 20px;\n      box-shadow: inset -5px 0px 25px rgba(0,0,0,.4);\n    }\n \n    #box li .name {\n      position: absolute;\n      left: -60px;\n      white-space: nowrap;\n    }\n \n    #box li .count {\n      margin-left: 15px;\n      position: absolute;\n      left: 100%;\n      font-size: 18px;\n      letter-spacing: 1px;\n      color: #fff;\n      font-style: italic;\n      text-shadow: 1px 0 2px #000, 0 1px 2px #000;\n    }\n</style>\n","html, body, div, ul, li, img, span {\n  padding: 0;\n  margin: 0;\n}\n\nul, li {\n  list-style: none;\n}\n\nspan {\n  display: inline-block;\n}\n\nimg {\n  vertical-align: top;\n}\n\n#box {\n  padding: 20px;\n  height: 700px;\n}\n\n#box ul {\n  padding-left: 20px;\n  position: relative;\n}\n\n#box li {\n  margin-left: 60px;\n  height: 28px;\n  box-sizing: border-box;\n  position: absolute;\n  line-height: 28px;\n  transition: width ease 1s, transform ease 1s, opacity ease 1s;\n  opacity: 0;\n  background: #ddd;\n  border-radius: 20px;\n  box-shadow: inset -5px 0px 25px rgba(0, 0, 0, 0.4);\n}\n\n#box li .name {\n  position: absolute;\n  left: -60px;\n  white-space: nowrap;\n}\n\n#box li .count {\n  margin-left: 15px;\n  position: absolute;\n  left: 100%;\n  font-size: 18px;\n  letter-spacing: 1px;\n  color: #fff;\n  font-style: italic;\n  text-shadow: 1px 0 2px #000, 0 1px 2px #000;\n}\n\n/*# sourceMappingURL=main.vue.map */"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$J = "data-v-62287bd5";
    /* module identifier */
    const __vue_module_identifier__$J = undefined;
    /* functional template */
    const __vue_is_functional_template__$J = false;
